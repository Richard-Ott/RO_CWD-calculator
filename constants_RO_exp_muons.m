...
switch nuclide
    case 10
        ...
        % attenuation lengths
        % for calculation of neutron effective attenuation length the
        % rigidity cutoff is needed. So I outsourced this function because
        % it requires lat lon, pressure etc
